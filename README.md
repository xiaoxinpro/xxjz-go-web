...
- **本地运行**: 见 [docs/README.md](docs/README.md)（后端、前端、导入旧数据）。
- **Docker**: `docker-compose up --build` 或 `make docker-build` 后 `docker run ...`。
...
| [scripts/](scripts/) | 构建脚本（build.sh / build.ps1） |
